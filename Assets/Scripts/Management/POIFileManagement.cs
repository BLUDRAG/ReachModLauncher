...
namespace ReachModLauncher
{
    ...
    {
        private static readonly (string type, string file, bool found)[] _requiredPOIFiles = new (string, string, bool)[]
                                                                                             {
	                                                                                             (".nim", null, false),
	                                                                                             (".ins", null, false),
	                                                                                             (".tts", null, false),
        ...
        private static readonly (string type, string file, bool found)[] _optionalPOIFiles = new (string, string, bool)[]
                                                                                             {
	                                                                                             (".mesh", null, false),
	                                                                                             (".jpg", null, false),
                                                                                             };
